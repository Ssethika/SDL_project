...
SDL_Texture* Renderer::LoadTextureFromSpriteSheet(SDL_Texture* spriteSheet, const SDL_Rect* rect) {
	...
	SDL_RenderCopy(renderer, spriteSheet, rect, NULL);
	SDL_SetRenderTarget(renderer, NULL);

	return texture;
}

void Renderer::DisplayTexture(SDL_Texture *texture, SDL_Rect* drt) {
  SDL_RenderCopy(renderer, texture, NULL, drt);
}
