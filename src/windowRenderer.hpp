...
public:
  ...
  virtual void DrawRectangle(v2<int> Position, v2<int> Dimension,
                             const Color &color) = 0;
	virtual SDL_Texture* LoadTextureFromSpriteSheet(SDL_Texture* spriteSheet,const SDL_Rect* rect) = 0;
  virtual void DisplayTexture(SDL_Texture *texture, SDL_Rect* src) = 0;
...
public:
  ...
  virtual void DrawRectangle(v2<int> position, v2<int> dimension,
	...
	virtual SDL_Texture* LoadTextureFromSpriteSheet(SDL_Texture* spriteSheet,const SDL_Rect* rect) override;
  virtual void DisplayTexture(SDL_Texture *texture, SDL_Rect* src) override;
